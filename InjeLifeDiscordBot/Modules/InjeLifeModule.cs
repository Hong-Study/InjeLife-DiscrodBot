...
public class InjeLifeModule : InteractionModuleBase<SocketInteractionContext>
{
    ...
    public InjeLifeModule(ConsoleLogger logger, SQLManager sqlManager)
    {
        _sqlManager = sqlManager;
        _logger = logger;
    }
    
    [SlashCommand("pong", "Hello World")]
    ...
    [SlashCommand("오늘", "금일의 학식을 보여드립니다.")]
    ...
    [SlashCommand("내일", "다음날의 학식을 보여드립니다.")]
